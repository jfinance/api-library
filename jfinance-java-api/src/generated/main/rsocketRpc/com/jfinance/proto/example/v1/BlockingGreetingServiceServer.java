...
@javax.inject.Named(
    value ="BlockingGreetingServiceServer")
public final class BlockingGreetingServiceServer extends io.rsocket.rpc.AbstractRSocketService {
  private final BlockingGreetingService service;
  ...
  @javax.inject.Inject
  public BlockingGreetingServiceServer(BlockingGreetingService service, java.util.Optional<reactor.core.scheduler.Scheduler> scheduler, java.util.Optional<io.micrometer.core.instrument.MeterRegistry> registry) {
    ...
    if (!registry.isPresent()) {
      ...
      this.greeting = io.rsocket.rpc.metrics.Metrics.timed(registry.get(), "rsocket.server", "service", BlockingGreetingService.SERVICE_ID, "method", BlockingGreetingService.METHOD_GREETING);
    }
  ...
  public String getService() {
    return BlockingGreetingService.SERVICE_ID;
  }
    ...
    try {
      ...
      switch(io.rsocket.rpc.frames.Metadata.getMethod(metadata)) {
        case GreetingService.METHOD_GREETING: {
          ...
          com.jfinance.proto.example.v1.GreetingRequest message = com.jfinance.proto.example.v1.GreetingRequest.parseFrom(is);
          return reactor.core.publisher.Mono.fromSupplier(() -> service.greeting(message, metadata)).map(serializer).transform(greeting).subscribeOn(scheduler);
        }
        default: {
